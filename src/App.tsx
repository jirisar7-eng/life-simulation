    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-indigo-500 selection:text-white">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400 font-medium">
                  Modulární architektura • Repozitář jirisar7-eng/life-simulation
                </p>
              </div>
            </div>
      ...
      <footer className="border-t border-slate-800/80 bg-slate-950 py-6 text-center text-xs text-slate-500">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <span>Life Simulation Engine • Architektonický plán pro <code className="text-slate-400 font-mono">jirisar7-eng/life-simulation</code></span>
          <span className="font-mono text-[11px] text-indigo-400">Kompletní specifikace uložena v ARCHITECTURE_PLAN.md</span>
        </div>
      </footer>
    </div>
  );
